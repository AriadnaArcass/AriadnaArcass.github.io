...
images: `<img src="ruta/a/imatgePregunta.jpg" alt="Imatge relacionada amb la pregunta">`  // Imatge opcional al final de la pregunta
    ...
    },
  {
        ...
        <p>O en Joules:</p>
        \\[
        1763,3 \\text{ W} \\cdot 600 \\text{ s} \\approx 1,06 \\text{ MJ}
        \\]
...
images: `<img src="ruta/a/imatgePregunta.jpg" alt="Imatge relacionada amb la pregunta">`  // Imatge opcional al final de la pregunta
    ...
    },
  {
        type: "exercicis", // Tipus de pregunta
        category: "enrgia",
        text: `El sistema públic d’il·luminació municipal d’una vila està format per \\( n = 308 \\) punts de llum, que estan encesos, de mitjana, \\( t = 11\\,\\text{hores} \\) al dia. Cada punt de llum utilitza una bombeta VSAP de potència \\( P_{VSAP} = 100\\,\\text{W} \\). La tarifa és \\( c_{electr} = 0{,}1370\\,€/(\\text{kWh}) \\). El cost de manteniment és \\( c_{mant} = 14\\,000\\,€ \\). Determineu:
